...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="container-fluid p-4" style="background-color: #FFF8F2; flex-grow: 1;">
            ...
            ?>
            <form method="post" action="aksi.php?mod=editbarang" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $r['id'] ?>">
                <div class="mb-3">
                    <label for="nama" class="form-label">Nama Barang</label>
                    <input type="text" name="nama" value="<?php echo $r['nama'] ?>" class="form-control" id="nama" placeholder="Masukkan nama barang">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" id="deskripsi" class="form-control" rows="3" placeholder="Masukkan deskripsi barang"><?php echo $r['deskripsi'] ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="harga" class="form-label">Harga</label>
                    <input type="text" name="harga" value="<?php echo $r['harga'] ?>" class="form-control" id="harga" placeholder="Masukkan harga barang">
                </div>
                <div class="mb-3">
                    <label for="gambar" class="form-label">Gambar Barang</label>
                    <input type="file" name="gambar" class="form-control" id="gambar">
                </div>
                <button type="submit" name="submit" value="submit" class="btn btn-success">Edit Barang</button>
            </form>
            <?php } ?>
        </div>
        <!-- Main Content End -->
